...
public class C24_Post_Deserialization extends HerokuappBaseUrl {
   ...
   */
    ...
    public void post01() {
        ...
        HashMap<String, Object> reqBody = testDataHerokuapp.bookingOlusturMap(); // request body'miz booking bilgilerini içeren body olduğundan
        // bookingOlusturMap()'i çağırdık

        // 2- Expected Data hazırla

        HashMap<String, Object> expData = testDataHerokuapp.expBodyOlusturMap(); // expected Data hepsini içeriyor bookingid ve booking'i
