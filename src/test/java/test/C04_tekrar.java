...
public class C04_tekrar {
    ...
    @Test
    public void put01(){
        // 1- Requestn URL VE Body hazirla
        ...
        // 2- soruda istendiyse Expected Data hazirla (soruda istenmemiş)


        //3- Response'i kaydet

        Response response= given().
                                   contentType(ContentType.JSON).  //Data formatını API'ta bildiriyoruz
                           when().
